![Python application](https://github.com/fingafrog/cvrp-poc/workflows/Python%20application/badge.svg)
...
![](https://github.com/fingafrog/cvrp-poc/blob/master/docs/img/v0.0.2_upload.PNG?raw=true)
